        ...
        @foreach ($links as $key => $link)
            ...
            <li class="menu-item active">
                <a href="{{ $link["url"] }}" class="menu-link">
                    ...
                    <div data-i18n="Analytics">{{ $key }}</div>
                </a>
            </li>
            @else
            <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    ...
                    <div data-i18n="Layouts">{{ $key }}</div>
                </a>
    
                <ul class="menu-sub">
                    @foreach ($link["sublinks"] as $key_sublink => $sublink)
                    <li class="menu-item">
                        <a href="{{ $sublink["url"] }}" class="menu-link">
                            <i class="mx-2 ml-0 {{ $sublink["icon"] }}"></i>
                            <div data-i18n="Without menu">{{ $key_sublink }}</div>
                        </a>
                    </li>
                    @endforeach
                </ul>
