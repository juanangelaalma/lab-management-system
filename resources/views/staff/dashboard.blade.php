    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="col-md-12 col-lg-12 order-1 mb-4">
                        <div class="card h-100 text-white bg-dark shadow">
                            <div class="card-header">
                                <h5 class="text-white">Grafik Kunjungan</h6>
                            </div>
        ...
        <div class="row" style="max-height: 400px;">
            <div class="col-md-12 h-100 col-lg-4 order-0 mb-4">
                <div class="card bg-dark shadow">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 me-2 text-white">Kunjungan hari ini</h5>
                    </div>
                        ...
                        <ul class="p-0 m-0 h-100">
                            @if (!$guestbooks->count())
                                <div class="h-100 d-flex justify-content-center align-items-center">
                                    <span class="text-center text-white">Maaf yaahh. Belum ada kunjungan hari ini 😥</span>
                                </div>
                            @else
            ...
            <div class="col-md-12 h-100 col-lg-4 order-0 mb-4">
                <div class="card bg-dark shadow">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 me-2 text-white">Inventori</h5>
                    </div>
            ...
            <div class="col-md-12 h-100 col-lg-4 order-0 mb-4">
                <div class="card bg-dark shadow">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 me-2 text-white">Peminjaman</h5>
                    </div>
                    <div class="card-body overflow-auto small-scrollbar d-flex flex-column justify-content-between"
                        style="height: 300px;">
                        <ul class="p-0 m-0 h-100">
